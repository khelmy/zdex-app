...
const initialState: IState = {
  ...
  prevApproveAuxZTStatus: undefined
};

const ApproveAuxZTModal: React.FunctionComponent<IProps> = (props) => {
  const {
    tokenAddress,
    amount,
    gasPrice,
  ...
  const [prevApproveAuxZTStatus, setPrevApproveAuxZTStatus] = useState(
    initialState.prevApproveAuxZTStatus
  );

  useEffect(
    () => {
      if (
        prevApproveAuxZTStatus === requestStatus.PENDING &&
      ...
      setPrevApproveAuxZTStatus(approveAuxZTStatus);
    },
    [approveAuxZTStatus, prevApproveAuxZTStatus]
  );
  ...
  const onSubmit = (e) => {
    ...
    approveAuxZT(tokenAddress, amount, gasPrice);
  };
          ...
          <div>
            ...
            {approveAuxZTId ? (
              <u>
                <a
                  target="_blank"
                  href={`${EXPLORER_URL}/transactions/${approveAuxZTId}`}
                  rel="noreferrer"
                >
...
export default ApproveAuxZTModal;
