...
import ConfirmAuthorizeLiquidityModal from '../confirm-authorize-liquidity-modal';
...
const AuthorizeLiquidityForm: React.FunctionComponent<IProps> = (props) => {
  const {
    address,
  ...
  return (
    <div>
        ...
        <Card>
          <div className="py-5">
            <div className="px-4 text-center">
              <h2 className="pb-2">
                <b>{'Authorize Liquidity Management'}</b>
              </h2>
              <Row>
      ...
      {isModalOpen ? (
        <ConfirmAuthorizeLiquidityModal
          authorizeLiquidityId={authorizeLiquidityId}
          authorizeLiquidityStatus={authorizeLiquidityStatus}
          tokenAddress={tokenAddress}
          amount={amount}
          gasPrice={minGasPriceInZil}
          isModalOpen={isModalOpen}
          authorizeLiquidity={props.authorizeLiquidity}
...
const mapStateToProps = (state) => ({
  ...
  authorizeLiquidityStatus: state.zil.authorizeLiquidityStatus,
  authorizeLiquidityId: state.zil.authorizeLiquidityId,
...
const mapDispatchToProps = (dispatch) => ({
  authorizeLiquidity: (tokenAddress, amount) => dispatch(zilActions.authorizeLiquidity(tokenAddress, amount)),
