...
import ConfirmApproveAuxTZModal from '../confirm-approve-aux-tz-modal';
...
const ApproveAuxTZForm: React.FunctionComponent<IProps> = (props) => {
  const {
    address,
    approveAuxTZStatus,
    approveAuxTZId,
  ...
  return (
    <div>
        ...
        <Card>
          <div className="py-5">
            <div className="px-4 text-center">
              <h2 className="pb-2">
                <b>{'Allow Hub to use TokenToZil'}</b>
              </h2>
              <Row>
      ...
      {isModalOpen ? (
        <ConfirmApproveAuxTZModal
          approveAuxTZId={approveAuxTZId}
          approveAuxTZStatus={approveAuxTZStatus}
          tokenAddress={tokenAddress}
          amount={amount}
          gasPrice={minGasPriceInZil}
          isModalOpen={isModalOpen}
          approveAuxTZ={props.approveAuxTZ}
...
const mapStateToProps = (state) => ({
  ...
  approveAuxTZStatus: state.zil.approveAuxTZStatus,
  approveAuxTZId: state.zil.approveAuxTZId,
...
const mapDispatchToProps = (dispatch) => ({
  approveAuxTZ: (tokenAddress, amount) => dispatch(zilActions.approveAuxTZ(tokenAddress, amount)),
